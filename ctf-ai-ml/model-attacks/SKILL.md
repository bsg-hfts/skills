---
name: model-attacks
description: "Techniques for attacking ML models directly: weight manipulation, model inversion, encoder collision, LoRA adapter exploitation, model extraction, and membership inference. For adversarial example gen"
license: MIT
...
<!-- Original file: ctf-ai-ml/model-attacks.md -->
...
Techniques for attacking ML models directly: weight manipulation, model inversion, encoder collision, LoRA adapter exploitation, model extraction, and membership inference. For adversarial example generation and data poisoning, see [adversarial-ml.md](../adversarial-ml/SKILL.md). For LLM-specific attacks, see [llm-attacks.md](../llm-attacks/SKILL.md).
