---
name: adversarial-ml
description: "Adversarial machine learning techniques: generating adversarial examples, physical-world patches, evasion attacks, data poisoning, and backdoor detection. For model weight manipulation and extraction"
license: MIT
...
<!-- Original file: ctf-ai-ml/adversarial-ml.md -->
