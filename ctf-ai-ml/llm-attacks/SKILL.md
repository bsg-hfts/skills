---
name: llm-attacks
description: "LLM-specific attack techniques: prompt injection, jailbreaking, token smuggling, context window manipulation, and tool use exploitation. For model weight attacks and extraction, see [model-attacks.md]"
license: MIT
...
<!-- Original file: ctf-ai-ml/llm-attacks.md -->
...
LLM-specific attack techniques: prompt injection, jailbreaking, token smuggling, context window manipulation, and tool use exploitation. For model weight attacks and extraction, see [model-attacks.md](../model-attacks/SKILL.md). For adversarial ML on image/tabular models, see [adversarial-ml.md](../adversarial-ml/SKILL.md).
