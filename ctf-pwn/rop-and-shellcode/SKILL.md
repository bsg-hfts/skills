---
name: rop-and-shellcode
description: "- [ROP Chain Building](#rop-chain-building)"
license: MIT
...
<!-- Original file: ctf-pwn/rop-and-shellcode.md -->
...
For double stack pivot, SROP with UTF-8 constraints, RETF architecture switch, seccomp bypass, .fini_array hijack, ret2vdso, pwntools template, and shellcode with input reversal, see [rop-advanced.md](../rop-advanced/SKILL.md).
