---
name: kernel-techniques
description: "- [tty_struct RIP Hijack and kROP](#tty_struct-rip-hijack-and-krop)"
license: MIT
...
<!-- Original file: ctf-pwn/kernel-techniques.md -->
...
For kernel fundamentals (environment setup, heap spray structures, stack overflow, privilege escalation, modprobe_path, core_pattern), see [kernel.md](../kernel/SKILL.md).
