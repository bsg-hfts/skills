---
name: heap-fsop
description: "FILE-structure (_IO_FILE) exploitation for libc 2.23-2.27+: fastbin→stdout vtable hijack, _IO_buf_base null byte overwrites, glibc 2.24+ vtable validation bypass, unsorted-bin attacks on FILE fields,"
license: MIT
...
<!-- Original file: ctf-pwn/heap-fsop.md -->
