---
name: advanced
description: "- [Seccomp Advanced Techniques](#seccomp-advanced-techniques)"
license: MIT
...
<!-- Original file: ctf-pwn/advanced.md -->
...
- [Kernel Exploitation](#kernel-exploitation) (basic; see [kernel.md](../kernel/SKILL.md) for full coverage)
...
**See also:** [heap-techniques.md](../heap-techniques/SKILL.md) — House of Apple 2, House of Einherjar, House of Orange/Spirit/Lore/Force, heap grooming, custom allocator exploitation (nginx, talloc), classic unlink, musl libc heap, tcache stashing unlink
...
See [rop-and-shellcode.md](../rop-and-shellcode/SKILL.md#rdx-control-in-rop-chains) for full details and code examples.
...
For comprehensive kernel exploitation techniques, see [kernel.md](../kernel/SKILL.md). Quick reference:
