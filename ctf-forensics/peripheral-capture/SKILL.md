---
name: peripheral-capture
description: "USB, HID, and Bluetooth peripheral traffic reconstruction from packet captures. For general network PCAP forensics (DNS/TCP/ICMP/SMB/RADIUS/RC4), see [network-advanced.md](../network-advanced/SKILL.md). For ba"
license: MIT
...
<!-- Original file: ctf-forensics/peripheral-capture.md -->
...
USB, HID, and Bluetooth peripheral traffic reconstruction from packet captures. For general network PCAP forensics (DNS/TCP/ICMP/SMB/RADIUS/RC4), see [network-advanced.md](../network-advanced/SKILL.md). For basic network forensics, see [network.md](../network/SKILL.md).
