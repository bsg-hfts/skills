---
name: network
description: "- [tcpdump Quick Reference](#tcpdump-quick-reference)"
license: MIT
...
<!-- Original file: ctf-forensics/network.md -->
...
See also: [network-advanced.md](../network-advanced/SKILL.md) for advanced network forensics techniques (packet interval timing encoding, USB HID mouse/pen drawing recovery, NTLMv2 hash cracking, TCP flag covert channels, DNS steganography, multi-layer PCAP with XOR, Brotli decompression bomb seam analysis, SMB RID recycling, Timeroasting MS-SNTP).
