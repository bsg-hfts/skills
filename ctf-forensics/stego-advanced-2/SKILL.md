---
name: stego-advanced-2
description: "See also: [stego-advanced.md](../stego-advanced/SKILL.md) for audio steganography (FFT frequency domain, DTMF, SSTV, LSB audio, musical notes, metadata encoding, waveform binary, spectrogram QR) and whitespace"
license: MIT
...
<!-- Original file: ctf-forensics/stego-advanced-2.md -->
...
See also: [stego-advanced.md](../stego-advanced/SKILL.md) for audio steganography (FFT frequency domain, DTMF, SSTV, LSB audio, musical notes, metadata encoding, waveform binary, spectrogram QR) and whitespace/archive encoding.
