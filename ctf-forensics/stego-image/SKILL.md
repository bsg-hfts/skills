---
name: stego-image
description: "Techniques specific to hiding data in image formats (JPEG, PNG, BMP, GIF). For non-image steganography (PDF, audio, terminal, text), see [steganography.md](../steganography/SKILL.md). For advanced techniques ("
license: MIT
...
<!-- Original file: ctf-forensics/stego-image.md -->
