---
name: stego-advanced
description: "See also: [stego-advanced-2.md](../stego-advanced-2/SKILL.md) for video frame techniques, JPEG XL TOC permutation, Arnold's Cat Map, SSTV FM demodulation, MJPEG steganography, EXIF/Stegano pixel patterns, PDF"
license: MIT
...
<!-- Original file: ctf-forensics/stego-advanced.md -->
...
See also: [stego-advanced-2.md](../stego-advanced-2/SKILL.md) for video frame techniques, JPEG XL TOC permutation, Arnold's Cat Map, SSTV FM demodulation, MJPEG steganography, EXIF/Stegano pixel patterns, PDF xref covert channels, ANSI escape code stego, and ECB image recovery.
