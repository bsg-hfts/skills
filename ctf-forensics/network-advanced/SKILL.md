...
description: "For USB/HID/Bluetooth peripheral capture analysis (mouse/pen drawing recovery, keyboard scan codes, LED Morse exfiltration, RFCOMM reassembly), see [peripheral-capture.md](../peripheral-capture/SKILL.md). For"
license: MIT
...
<!-- Original file: ctf-forensics/network-advanced.md -->
...
For USB/HID/Bluetooth peripheral capture analysis (mouse/pen drawing recovery, keyboard scan codes, LED Morse exfiltration, RFCOMM reassembly), see [peripheral-capture.md](../peripheral-capture/SKILL.md). For basic network forensics, see [network.md](../network/SKILL.md).
...
See also: [network.md](../network/SKILL.md) for basic network forensics techniques (tcpdump, TLS/SSL decryption, Wireshark, port scanning, SMB3 decryption, credential extraction, 5G protocols).
