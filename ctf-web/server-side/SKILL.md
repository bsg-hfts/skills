---
name: server-side
description: "- [PHP Type Juggling](#php-type-juggling)"
license: MIT
...
<!-- Original file: ctf-web/server-side.md -->
...
- [SQL Injection](#sql-injection) — moved to [sql-injection.md](../sql-injection/SKILL.md)
...
SQL injection techniques have been moved to a dedicated file. See [sql-injection.md](../sql-injection/SKILL.md) for all SQL injection techniques.
...
See [server-side-2.md](../server-side-2/SKILL.md) for XXE, XML injection, command injection, GraphQL, and the remaining PHP-specific tricks (variable variables, uniqid, sequential regex bypass).
