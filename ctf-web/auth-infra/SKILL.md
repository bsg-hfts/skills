---
name: auth-infra
description: "- [OAuth/OIDC Exploitation](#oauthoidc-exploitation)"
license: MIT
...
<!-- Original file: ctf-web/auth-infra.md -->
...
For JWT/JWE token attacks, see [auth-jwt.md](../auth-jwt/SKILL.md). For general auth bypass and access control, see [auth-and-access.md](../auth-and-access/SKILL.md).
...
*See also [ctf-crypto/modern-ciphers-2.md — Hash Length Extension Attack (PlaidCTF 2014)](../../ctf-crypto/modern-ciphers-2/SKILL.md#hash-length-extension-attack-plaidctf-2014) for the canonical crypto writeup of the same primitive.*
