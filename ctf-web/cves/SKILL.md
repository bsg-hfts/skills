---
name: cves
description: "Specific CVEs and vulnerability patterns. For Node.js CVEs (flatnest, Happy-DOM), see [node-and-prototype.md](../node-and-prototype/SKILL.md). For JWT algorithm confusion, see [auth-and-access.md](auth-and-acc"
license: MIT
...
Specific CVEs and vulnerability patterns. For Node.js CVEs (flatnest, Happy-DOM), see [node-and-prototype.md](../node-and-prototype/SKILL.md). For JWT algorithm confusion, see [auth-and-access.md](../auth-and-access/SKILL.md).
...
See [server-side.md](../server-side/SKILL.md) for full details.
...
See [server-side-advanced.md](../server-side-advanced/SKILL.md#exiftool-cve-2021-22204--djvu-perl-injection-0xfun-2026) for full exploit code.
...
See [server-side-advanced-4.md](../server-side-advanced-4/SKILL.md#react-server-components-flight-protocol-rce-ehax-2026) for full exploit chain.
...
7. **Node.js libraries** — see [node-and-prototype.md](../node-and-prototype/SKILL.md) for full list
