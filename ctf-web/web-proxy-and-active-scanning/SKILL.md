...
4. Repeticion dirigida: Intruder/Fuzzer en parametros de alto valor.
...
- Burp Suite (Proxy, Repeater, Intruder, Comparer, Logger)
...
2. Agrupa endpoints por funcion y nivel de privilegio.
3. Lanza escaneo activo solo en endpoints con estado reproducible.
4. Promueve findings con PoC minimo a skills de explotacion especificos.
