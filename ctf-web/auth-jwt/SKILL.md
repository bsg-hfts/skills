---
name: auth-jwt
description: "- [Algorithm None](#algorithm-none)"
license: MIT
...
<!-- Original file: ctf-web/auth-jwt.md -->
...
For general auth bypass, access control, and session attacks, see [auth-and-access.md](../auth-and-access/SKILL.md). For OAuth/OIDC, SAML, CI/CD credential theft, and infrastructure auth attacks, see [auth-infra.md](../auth-infra/SKILL.md).
