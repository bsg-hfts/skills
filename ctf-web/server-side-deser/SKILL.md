...
description: "For core injection attacks (SQLi, SSTI, SSRF, XXE, command injection), see [server-side.md](../server-side/SKILL.md)."
license: MIT
...
<!-- Original file: ctf-web/server-side-deser.md -->
...
For core injection attacks (SQLi, SSTI, SSRF, XXE, command injection), see [server-side.md](../server-side/SKILL.md).
