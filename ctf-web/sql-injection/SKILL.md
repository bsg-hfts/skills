---
name: sql-injection
description: "Comprehensive SQL injection techniques for CTF challenges. For other server-side attacks (SSTI, SSRF, XXE, command injection, GraphQL), see [server-side.md](../server-side/SKILL.md)."
license: MIT
...
<!-- Original file: ctf-web/sql-injection.md -->
...
Comprehensive SQL injection techniques for CTF challenges. For other server-side attacks (SSTI, SSRF, XXE, command injection, GraphQL), see [server-side.md](../server-side/SKILL.md).
