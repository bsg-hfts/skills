---
name: games-and-vms-2
description: "- [Cookie Checkpoint Game Brute-Forcing (BYPASS CTF 2025)](#cookie-checkpoint-game-brute-forcing-bypass-ctf-2025)"
license: MIT
...
<!-- Original file: ctf-misc/games-and-vms-2.md -->
...
See also: [games-and-vms.md](../games-and-vms/SKILL.md) for WASM patching, Roblox reversing, PyInstaller, Z3, K8s RBAC, floating-point exploitation, custom assembly sandbox escape, and multi-phase crypto games.
