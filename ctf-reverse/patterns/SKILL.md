---
name: patterns
description: "- [Custom VM Reversing](#custom-vm-reversing)"
license: MIT
...
<!-- Original file: ctf-reverse/patterns.md -->
...
For malware patching, multi-stage shellcode loaders, timing/signal oracles, and CTF-specific runtime attacks (INT3 coredump oracle, signal handler chain, printf format string VM, quadtree image format), see [patterns-runtime.md](../patterns-runtime/SKILL.md).
...
See [patterns-runtime.md](../patterns-runtime/SKILL.md) for malware patching, multi-stage shellcode, timing/signal oracles, and CTF writeup techniques.
