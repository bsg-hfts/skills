---
name: patterns-ctf-3
description: "- [Z3 for Single-Line Python Boolean Circuit (BearCatCTF 2026)](#z3-for-single-line-python-boolean-circuit-bearcatctf-2026)"
license: MIT
...
<!-- Original file: ctf-reverse/patterns-ctf-3.md -->
...
See also: [patterns-ctf.md](../patterns-ctf/SKILL.md) for Part 1, [patterns-ctf-2.md](../patterns-ctf-2/SKILL.md) for Part 2 (multi-layer self-decrypting binary, embedded ZIP+XOR license, stack string deobfuscation, prefix hash brute-force, CVP/LLL lattice, decision tree obfuscation, GF(2^8) Gaussian elimination).
