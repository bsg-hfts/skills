...
description: "- [Roblox Place File Analysis](#roblox-place-file-analysis)"
license: MIT
...
<!-- Original file: ctf-reverse/languages-platforms.md -->
...
For core language reversing (Python, BF/esolangs, DOS, Unity, OPAL), see [languages.md](../languages/SKILL.md).
For Go and Rust binary reversing, see [languages-compiled.md](../languages-compiled/SKILL.md).
...
See [patterns-ctf-2.md](../patterns-ctf-2/SKILL.md#prefix-hash-brute-force-nullcon-2026) for the full technique. This section covers language-specific considerations.
