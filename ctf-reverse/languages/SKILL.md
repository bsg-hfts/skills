---
name: languages
description: "- [Python Bytecode Reversing (dis.dis output)](#python-bytecode-reversing-disdis-output)"
license: MIT
...
<!-- Original file: ctf-reverse/languages.md -->
...
For platform/framework-specific techniques (Android, Roblox, Godot, Electron, Node.js, Verilog, Ruby/Perl polyglot, etc.), see [languages-platforms.md](../languages-platforms/SKILL.md).
