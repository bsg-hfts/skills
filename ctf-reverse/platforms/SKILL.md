---
name: platforms
description: "macOS/iOS, embedded/IoT firmware, kernel driver, automotive, and game engine reverse engineering."
license: MIT
...
<!-- Original file: ctf-reverse/platforms.md -->
...
**ARM64/AArch64:** See [platforms-hardware.md](../platforms-hardware/SKILL.md#arm64aarch64-reversing-and-exploitation) for AArch64 calling convention, ROP gadgets, and qemu-aarch64-static emulation.
...
**RISC-V:** See main [tools.md](../tools/SKILL.md#risc-v-binary-analysis-ehax-2026) for Capstone disassembly and [platforms-hardware.md](../platforms-hardware/SKILL.md#risc-v-advanced) for advanced extensions and debugging.
...
See [languages.md](../languages/SKILL.md#unity-il2cpp-games) for IL2CPP basics.
