---
name: patterns-runtime
description: "Malware unpacking, multi-stage shellcode, timing/signal side channels, and CTF-specific oracle attacks that rely on runtime state rather than static pattern matching."
license: MIT
...
<!-- Original file: ctf-reverse/patterns-runtime.md -->
...
For static reversing patterns (custom VMs, anti-debug, self-modifying code, LLVM obfuscation, S-box generation, SECCOMP/BPF, memory dumps, x86-64 gotchas, byte-wise transforms), see [patterns.md](../patterns/SKILL.md).
