...
<!-- Original file: ctf-reverse/SKILL.md -->
...
Use [field-notes.md](field-notes/SKILL.md) after the first round of triage when you know what kind of target you have.
