---
name: prng
description: "Foundational PRNG state/seed recovery techniques. For CTF-era advanced attacks (MT19937 constraint propagation, Rule 86 cellular automaton, Java LCG MITM, LFSR bit-fold, Z3 timing oracle, randcrack DS"
license: MIT
...
<!-- Original file: ctf-crypto/prng.md -->
...
Foundational PRNG state/seed recovery techniques. For CTF-era advanced attacks (MT19937 constraint propagation, Rule 86 cellular automaton, Java LCG MITM, LFSR bit-fold, Z3 timing oracle, randcrack DSA, NTP-poisoned UUID), see [prng-attacks.md](../prng-attacks/SKILL.md).
...
See [prng-attacks.md](../prng-attacks/SKILL.md) for CTF-era advanced attacks (2017+).
