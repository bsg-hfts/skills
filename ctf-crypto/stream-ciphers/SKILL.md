---
name: stream-ciphers
description: "LFSR, RC4, and XOR-based stream cipher attacks. For block cipher attacks (AES, padding oracle, MAC forgery), see [modern-ciphers.md](../modern-ciphers/SKILL.md)."
license: MIT
...
<!-- Original file: ctf-crypto/stream-ciphers.md -->
...
LFSR, RC4, and XOR-based stream cipher attacks. For block cipher attacks (AES, padding oracle, MAC forgery), see [modern-ciphers.md](../modern-ciphers/SKILL.md).
