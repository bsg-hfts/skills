---
name: rsa-attacks
description: "- [Small Public Exponent (Cube Root)](#small-public-exponent-cube-root)"
license: MIT
...
<!-- Original file: ctf-crypto/rsa-attacks.md -->
...
- [rsa-attacks-2.md: RSA p=q Validation Bypass (BearCatCTF 2026)](../rsa-attacks-2/SKILL.md#rsa-pq-validation-bypass-bearcatctf-2026)
- [rsa-attacks-2.md: RSA Cube Root CRT when gcd(e, phi) > 1 (BearCatCTF 2026)](../rsa-attacks-2/SKILL.md#rsa-cube-root-crt-when-gcde-phi--1-bearcatctf-2026)
- [rsa-attacks-2.md: Factoring n from Multiple of phi(n) (BearCatCTF 2026)](../rsa-attacks-2/SKILL.md#factoring-n-from-multiple-of-phin-bearcatctf-2026)
- [rsa-attacks-2.md: RSA Signature Forgery via Multiplicative Homomorphism (MMA CTF 2015)](../rsa-attacks-2/SKILL.md#rsa-signature-forgery-via-multiplicative-homomorphism-mma-ctf-2015)
- [rsa-attacks-2.md: Weak RSA Key Generation via Base Representation (Sharif CTF 2016)](../rsa-attacks-2/SKILL.md#weak-rsa-key-generation-via-base-representation-sharif-ctf-2016)
- [rsa-attacks-2.md: RSA with gcd(e, phi(n)) > 1 (CSAW 2015)](../rsa-attacks-2/SKILL.md#rsa-with-gcde-phin--1-csaw-2015)
- [rsa-attacks-2.md: Batch GCD for Shared Prime Factoring (BSidesSF 2025)](../rsa-attacks-2/SKILL.md#batch-gcd-for-shared-prime-factoring-bsidessf-2025)
- [rsa-attacks-2.md: RSA Partial Key Recovery from dp dq qinv (0CTF 2016)](../rsa-attacks-2/SKILL.md#rsa-partial-key-recovery-from-dp-dq-qinv-0ctf-2016)
- [rsa-attacks-2.md: RSA-CRT Fault Attack / Bit-Flip Recovery (CSAW CTF 2016)](../rsa-attacks-2/SKILL.md#rsa-crt-fault-attack--bit-flip-recovery-csaw-ctf-2016)
- [rsa-attacks-2.md: RSA Homomorphic Decryption Oracle Bypass (ECTF 2016)](../rsa-attacks-2/SKILL.md#rsa-homomorphic-decryption-oracle-bypass-ectf-2016)
- [rsa-attacks-2.md: RSA with Small Prime Factors and CRT Decomposition (Hack The Vote 2016)](../rsa-attacks-2/SKILL.md#rsa-with-small-prime-factors-and-crt-decomposition-hack-the-vote-2016)
...
See [advanced-math.md](../advanced-math/SKILL.md) for full implementation.
...
See [advanced-math.md](../advanced-math/SKILL.md) for GF(2)[x] polynomial arithmetic and CRT implementation.
...
See [advanced-math.md](../advanced-math/SKILL.md) for CRT approach and Gauss-Jordan implementation.

See also: [rsa-attacks-2.md](../rsa-attacks-2/SKILL.md) for specialized RSA techniques (p=q bypass, cube root CRT, phi(n) multiple factoring, signature forgery, weak keygen, batch GCD, partial key recovery, CRT fault attack, homomorphic bypass).
